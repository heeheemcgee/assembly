...
func BuildOverlapNetwork() {
	...
	fmt.Println("Making overlap network. Please wait...")
	...
	fmt.Println("We made it! Contigs converted to strings. You can find the new .fasta files in the Output folder.")
